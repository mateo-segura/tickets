...
@Composable
fun TecnicoAcceptedTicketList(navController: NavController, userID: Int,token:String) {
    ...
    LazyColumn(
        ...
        items(AceptedTickets) { ticket ->
            TecnicoAcceptedTicketCard(ticket, navController, userID)
        }
    }
}
