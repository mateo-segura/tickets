...
@Composable
fun TecnicoNonAcceptedTicketCard(nonAcceptedTicket: NonAcceptedTicket, navController: NavController,userID:Int, jwtToken: String) {
    val padding = 10.dp
    ...
    Card(
        modifier = Modifier
            ...
            .padding(10.dp)
            .clickable {
                //navController.navigate("detailnonaccepted/${jsonTicket}")
                showSheet = true
            },
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = "${nonAcceptedTicket.title.take(13)}...",
...
//                    )
                    Text(
                        "Categoría: ${nonAcceptedTicket.category}",
                        fontSize = fontSizeNormal
                    )
                    Spacer(Modifier.size(padding))
                    Text(
                        nonAcceptedTicket.createdAt.take(10),
                        fontSize = fontSizeNormal,
                        fontWeight = FontWeight.Bold
                    )
                }
